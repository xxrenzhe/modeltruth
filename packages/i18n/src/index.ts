...
const dictionaries = {
  en: {
    ...
    legal: {
      disclaimerTitle: "Technical results notice",
      disclaimer:
        "Results are generated by automated technical tests at a specific time and under specific conditions. They are not legal conclusions, endorsements, or accusations of wrongdoing. Providers may submit corrections or dispute a result."
    },
    home: {
  ...
  "zh-CN": {
    ...
    legal: {
      disclaimerTitle: "技术结果说明",
      disclaimer:
        "结果由自动化技术测试在特定时间和条件下生成，不构成法律结论、背书或不当行为指控。供应商可以提交更正或申诉。"
    },
    home: {
      eyebrow: "Trust, but verify every token",
