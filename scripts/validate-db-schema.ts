...
const criticalColumns: Record<string, string[]> = {
  ...
  gtm_daily_visitors: ["day", "surface", "visitor_hash", "first_seen_at", "last_seen_at", "visit_count"],
  gtm_external_metric_snapshots: ["source", "metric_value", "captured_at", "metadata_json"],
...
const criticalIndexes = [
  ...
  "idx_gtm_daily_visitors_surface_day",
  "idx_gtm_external_metric_snapshots_captured",
