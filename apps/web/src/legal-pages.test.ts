...
describe("legal compliance pages", () => {
  ...
  it("privacy page covers data categories, purpose, retention and third-party processors", () => {
    ...
    for (const required of [
      ...
      "CLI telemetry is off by default; anonymous CLI telemetry and uploads both require explicit consent",
      "anonymous product metrics",
      "anonymous web visit telemetry only with opt-in consent",
      "coarse surfaces, not raw paths, API keys, prompts or completions",
      "privacy-reset clears local CLI session, audit history and telemetry visitor id",
